...
The [synthetic SSI benchmark data](https://deepblue.lib.umich.edu/data/concern/data_sets/5d86p133v) and [reconstructed SSI data product](https://deepblue.lib.umich.edu/data/concern/data_sets/rx913r011) by SIAP are publicly available.
...
2. Synthetic SSI, v3.2, accessed Apr 18 2023, generated based on [CMIP6, v3.2](https://doi.org/10.22033/ESGF/input4MIPs.1122) record (used in simulation section). A copy of the synthetic SSI is available at [this link](https://doi.org/10.7302/38cw-1j08).
